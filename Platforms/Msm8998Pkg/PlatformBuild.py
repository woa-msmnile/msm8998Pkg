# @file
# Script to Build Msm8998 Mu UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("Msm8998Pkg",)
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE", "NOOPT")
    Scopes = ('Msm8998', 'edk2-build', 'cibuild')
    WorkspaceRoot = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
    PackagesPath = ("Binaries", "Platforms", "MU_BASECORE", "Common/MU", "Common/MU_TIANO", "Common/MU_OEM_SAMPLE", "Common/MU_FEATURE_DFCI", "Silicon/ARM/TIANO", "Silicon/QC/Msm8998")
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def GetTargetDeviceDirectory(self):
        ...
        return os.path.join("Platforms", "Msm8998Pkg", "Device", target_device)
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "Msm8998", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "Msm8998Pkg/Msm8998.dsc", "Platform Hardcoded")
